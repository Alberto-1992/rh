...
$query = $conexion2->query("UPDATE descripcionesmetas set resultadobtenido = '$resultadoObtenido1' where id_empleado = '$identificador'");
$query = $conexion2->query("UPDATE descripcionesmetas set resultadobtenido2 = '$resultadoObtenido2' where id_empleado = '$identificador'");
$query = $conexion2->query("UPDATE descripcionesmetas set resultadobtenido3 = '$resultadoObtenido3' where id_empleado = '$identificador'");
$query = $conexion2->query("UPDATE descripcionesmetas set resultadobtenido4 = '$resultadoObtenido4' where id_empleado = '$identificador'");
$query = $conexion2->query("UPDATE descripcionesmetas set resultadobtenido5 = '$resultadoObtenido5' where id_empleado = '$identificador'");
$query = $conexion2->query("UPDATE descripcionesmetas set resultadobtenido6 = '$resultadoObtenido6' where id_empleado = '$identificador'");
$query = $conexion2->query("UPDATE descripcionesmetas set comentario = '$comentarioOperativo' where id_empleado = '$identificador'");

$query1 = "INSERT INTO metasdocumento(tipo, size, identificador) 
    ...
    mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
        ...
        if($_FILES["fichero1"]["error"]>0){
         ...
         if(in_array($_FILES["fichero1"]["type"], $permitidos) && $_FILES["fichero1"]["size"]){
             ...
             $ruta = 'archivos/'.$evidencia1.$identificador.'/';
     ...
     $update =" UPDATE metasdocumento SET tipo = '".$_FILES['fichero1']['type']."', size = '".$_FILES['fichero1']['size']."' WHERE identificador = '$identificador' limit 1";
    ...
    mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
        ...
        if($_FILES["fichero2"]["error"]>0){
         ...
         if(in_array($_FILES["fichero2"]["type"], $permitidos) && $_FILES["fichero2"]["size"]){
             ...
             $ruta = 'archivos/'.$evidencia2.$identificador.'/';
     ...
     $update =" UPDATE metasdocumento SET tipo = '".$_FILES['fichero2']['type']."', size = '".$_FILES['fichero2']['size']."' WHERE identificador = '$identificador' limit 1";
     mysqli_query($conexion2, $update);
     if($_FILES["fichero2"]["error"]>0){
    ...
    mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
        ...
        if($_FILES["fichero3"]["error"]>0){
         ...
         if(in_array($_FILES["fichero3"]["type"], $permitidos) && $_FILES["fichero3"]["size"]){
             
             $ruta = 'archivos/'.$evidencia3.$identificador.'/';
     ...
     $update =" UPDATE metasdocumento SET tipo = '".$_FILES['fichero3']['type']."', size = '".$_FILES['fichero3']['size']."' WHERE identificador = '$identificador' limit 1";
     mysqli_query($conexion2, $update);
     if($_FILES["fichero3"]["error"]>0){
     ...
     mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
         ...
         if($_FILES["archio4"]["error"]>0){
          ...
          if(in_array($_FILES["archio4"]["type"], $permitidos) && $_FILES["archio4"]["size"]){
              ...
              $ruta = 'archivos/'.$evidencia4.$identificador.'/';
      ...
      $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio4']['type']."', size = '".$_FILES['archio4']['size']."' WHERE identificador = '$identificador' limit 1";
      mysqli_query($conexion2, $update);
      if($_FILES["archio4"]["error"]>0){
      ...
      mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
          ...
          if($_FILES["archio5"]["error"]>0){
           ...
           if(in_array($_FILES["archio5"]["type"], $permitidos) && $_FILES["archio5"]["size"]){
               ...
               $ruta = 'archivos/'.$evidencia5.$identificador.'/';
       ...
       $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio5']['type']."', size = '".$_FILES['archio5']['size']."' WHERE identificador = '$identificador' limit 1";
       mysqli_query($conexion2, $update);
       if($_FILES["archio5"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio6"]["error"]>0){
            ...
            if(in_array($_FILES["archio6"]["type"], $permitidos) && $_FILES["archio6"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia6.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio6']['type']."', size = '".$_FILES['archio6']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio6"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio7"]["error"]>0){
            ...
            if(in_array($_FILES["archio7"]["type"], $permitidos) && $_FILES["archio7"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia7.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio7']['type']."', size = '".$_FILES['archio7']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio7"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio8"]["error"]>0){
            ...
            if(in_array($_FILES["archio8"]["type"], $permitidos) && $_FILES["archio8"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia8.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio8']['type']."', size = '".$_FILES['archio8']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio8"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio9"]["error"]>0){
            ...
            if(in_array($_FILES["archio9"]["type"], $permitidos) && $_FILES["archio9"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia9.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio9']['type']."', size = '".$_FILES['archio9']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio9"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio10"]["error"]>0){
            ...
            if(in_array($_FILES["archio10"]["type"], $permitidos) && $_FILES["archio10"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia10.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio10']['type']."', size = '".$_FILES['archio10']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio10"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio11"]["error"]>0){
            ...
            if(in_array($_FILES["archio11"]["type"], $permitidos) && $_FILES["archio11"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia11.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio11']['type']."', size = '".$_FILES['archio11']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio11"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio12"]["error"]>0){
            ...
            if(in_array($_FILES["archio12"]["type"], $permitidos) && $_FILES["archio12"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia12.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio12']['type']."', size = '".$_FILES['archio12']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio12"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio13"]["error"]>0){
            ...
            if(in_array($_FILES["archio13"]["type"], $permitidos) && $_FILES["archio13"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia13.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio13']['type']."', size = '".$_FILES['archio13']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio13"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio14"]["error"]>0){
            ...
            if(in_array($_FILES["archio14"]["type"], $permitidos) && $_FILES["archio14"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia14.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio14']['type']."', size = '".$_FILES['archio14']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio14"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio15"]["error"]>0){
            ...
            if(in_array($_FILES["archio15"]["type"], $permitidos) && $_FILES["archio15"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia15.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio15']['type']."', size = '".$_FILES['archio15']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio15"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio16"]["error"]>0){
            ...
            if(in_array($_FILES["archio16"]["type"], $permitidos) && $_FILES["archio16"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia16.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio16']['type']."', size = '".$_FILES['archio16']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio16"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio17"]["error"]>0){
            ...
            if(in_array($_FILES["archio17"]["type"], $permitidos) && $_FILES["archio17"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia17.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio17']['type']."', size = '".$_FILES['archio17']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio17"]["error"]>0){
       ...
       mysqli_query($conexion2, $query1) or die ("Problemas al insertar1".mysqli_error($conexion2));
           ...
           if($_FILES["archio18"]["error"]>0){
            ...
            if(in_array($_FILES["archio18"]["type"], $permitidos) && $_FILES["archio18"]["size"]){
                ...
                $ruta = 'archivos/'.$evidencia18.$identificador.'/';
            ...
            $update =" UPDATE metasdocumento SET tipo = '".$_FILES['archio18']['type']."', size = '".$_FILES['archio18']['size']."' WHERE identificador = '$identificador' limit 1";
            mysqli_query($conexion2, $update);
            if($_FILES["archio18"]["error"]>0){
