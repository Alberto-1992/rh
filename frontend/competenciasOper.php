...
//include("menu.php");
    ?>
 <input type="submit" style="width: 150px; height: 40px; margin-left: 30px; cursor: pointer; float:left; margin-top: 15px;" class="btn-warning" value="Rgresar" id="back" onclick="window.location.href='principal.php'"></input>
...
<div class="form-group">
    <br><div style="margin-left: auto; margin-right: auto; width: 80%; height: auto; border: 1px solid black; margin-top: -15px;">
              ...
              <strong style="float: left; margin-left: 90px; font-size: 16px; font-style: italic;">Terminada:</strong>&nbspSe completó todo ek preceso, no se puede modificar.<br><br>
  ...
  <tbody>
    <?php 
      ...
      while($row_s=$sql->fetch_assoc())
      {
        ...
        <td>'.$row_s['rfc'].'</td>
        <td>'.$row_s['nombre'].'</td>
        <td><a href="evaluarOper.php?eval='.$val.'">Evaluar</a></td>
