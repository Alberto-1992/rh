...
<body>
 ...
 $sql = $conexion2->query("SELECT * FROM descripcionesmetas2022 where id_empleado = $id");
    ...
    ?>
    <?php
        if($validarid == 2 or $validarid == 1){
            require 'metasResultado2021Vista.php';
        }else if($validarid == 3 or $validarid == 5){
            if($validarid == 3){
                echo "<script>alert('Tus metas han sido rechazadas por tu jefe directo');</script>";
            }
        ?>

    <form action="almacenarResultado2021" method="POST">
    </form>

    <form action="almacenarResultado2021" method="POST" enctype="multipart/form-data">
        ...
        <div class="all">
            ...
            <div id="contenedor">
                ...
                <div class="instrucciones" style="background: #285c4d; margin-top: 3px;">
...
d) Documentos de autoevaluación relacionados con el diseño y la implementación de procesos y sistemas dentro del Modelo de Seguridad del Paciente del CSG evidenciando el cumplimeinto del 100% de los requisitos ponderados como "indispensables", el 80% o más de los "Necesarios" y el 50% o más de los "Convenientes".</textarea><br><br><br><br><br><br><br><br>
            ...
            -->
                ...
                <div id="cuerpo" style="background: #ECF0F1; width: auto; height: auto;">
                    ...
                    <textarea name="resultadoObtenido1" id="textarea"
                        style="width: 40%; height: 140px; margin-left: 5%;" id="textarea"
                    ...
                    <div class="form-row" style="margin-left: 3%;">
                        <div class="col-md4">
                            ...
                            <input type="text" name="inputUno" class="form-control"
                        ...
                        <div class="col-md4">
                            ...
                            <input type="text" name="inputDos" class="form-control"
                                style="float: left; margin-left: 0%;" value="<?php echo $row['NivelCumpAproMeta1']; ?>">
                        </div>
                        <div class="col-md4">
                            <label>Satisfactorio</label>
                            <input id="nivel_cump" name="nivel_cump" type="radio" onclick="nivel_local();"
                                style="float: left; margin-left: 3%;" value="80"
                                <?php echo $row['nivelescumplimiento1']; ?>
                                <?php if ($row['nivelescumplimiento1'] == "80") echo 'checked="checked"' ?> />
                            <input type="text" name="inputTres" class="form-control"
                                style="float: left; margin-left: 0%;"
                        ...
                        <div class="col-md4">
                            ...
                            <input type="text" class="form-control" style="float: left; margin-left: 0%;"
                                name="inputCuatro" value="<?php echo $row['NivelCumpSobreMeta1']; ?>">
                        </div>
                    </div><br>
                    ...
                    <div id="evidencias"
                        ...
                        <br>
                        <strong style="float: left; margin-left: 0px; color: black; ">Sube tus evidencias en
                            pdf</strong>
                        <input type="file" name="fichero1"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                    ...
                    <input type="submit" name="guardar" class="btn btn-success" value="  + GUARDAR META"
                    ...
                    function nivel_local() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "actualiza_cumplimiento2021.php",
                            data: ob,
                ...
                <div id="cuerpo" style="background:  #FBFCFC; width: 100%; height: auto;">
                    ...
                    <strong style="float: left; margin-left: 5%;">Meta individual</strong><br>
                    <textarea name="meta2" readonly="readonly" style="width: 40%; height: 140px; margin-left: 5%;"
                        id="textarea"
                        class="md-textarea form-control"><?php echo $row['redacionMeta2']; ?></textarea><br><br><br><br><br><br>
                    <strong style="float: left; margin-left: 5%;">Resultado obtenido</strong><br>
                    <textarea name="resultadoObtenido2" style="width: 40%; height: 140px; margin-left: 5%;"
                        id="textarea"
                    ...
                    <div class="form-row" style="margin-left: 3%;">
                        ...
                        <div class="col-md4">
                            <label>Sobresaliente</label>
                            <input name="nivel_cump2" id="nivel_cump2" type="radio" onclick="nivel_local2();"
                                value="100" <?php echo $row['nivelescumplimiento2']; ?>
                    ...
                    <div id="evidencias"
                        ...
                        <strong style="float: left; margin-left: 0px; color: black; ">Sube tus evidencias en
                            pdf</strong>
                        <input type="file" name="archio4"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio5"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio6"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">

                    </div>
                    <input type="submit" name="guardar" class="btn btn-success" value="  + GUARDAR META"
                        style="margin-left:50%; transform: translateX(-50%);"><br>
                ...
                <div id="cuerpo" style="background: #ECF0F1; width: 100%; height: auto;">
                    ...
                    <strong style="float: left; margin-left: 5%;">Resultado obtenido</strong><br>
                    <textarea name="resultadoObtenido3" style="width: 40%; height: 140px; float: left; margin-left: 5%"
                        id="textarea"
                    ...
                    <div id="evidencias"
                        ...
                        <strong style="float: left; margin-left: 0px; color: black;">Sube tus evidencias en
                            pdf</strong><br>
                        <input type="file" name="archio7"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio8"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio9"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                    </div>
                    <input type="submit" name="guardar" class="btn btn-success" value="  + GUARDAR META"
                        style="margin-left:50%; transform: translateX(-50%);">
                ...
                <div id="cuerpo" style="background: #FDFEFE; width: 100; height: auto;">
                    ...
                    <strong style="float: left; margin-left: 5%;">Resultado obtenido</strong><br>
                    <textarea name="resultadoObtenido4" style="width: 40%; height: 140px; float: left; margin-left: 5%;"
                        id="textarea"
                    ...
                    <div id="evidencias"
                        ...
                        <strong style="float: left; margin-left: 0px; color: black;">Sube tus evidencias en
                            pdf</strong><br>
                        <input type="file" name="archio10"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio11"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio12"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                    </div>
                    <input type="submit" name="guardar" class="btn btn-success" value="  + GUARDAR META"
                        style="margin-left:50%; transform: translateX(-50%);"><br>
                ...
                <div id="cuerpo" style="background: #ECF0F1; widht: 100%; height: auto;">
                    ...
                    <strong style="float: left; margin-left: 5%;">Resultado obtenido</strong><br>
                    <textarea name="resultadoObtenido5" style="width: 40%; height: 140px; float: left; margin-left: 5%;"
                        id="textarea"
                    ...
                    <div id="evidencias"
                        ...
                        <strong style="float: left; margin-left: 0px; color: black;">Sube tus evidencias en
                            pdf</strong><br>
                        <input type="file" name="archio13"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio14"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                        <input type="file" name="archio15"
                            style="margin-left: 0px; border-radius: 15px; margin-top: 5px;">
                    </div>
                    <input type="submit" name="guardar" class="btn btn-success" value="  + GUARDAR META"
                        style="margin-left:50%; transform: translateX(-50%);">
    ...
    <div class="contenedor-final"
        style="background-color: #A9A9A9; background-size: 100% 100%; background-repeat: no-repeat;">
        ...
        <?php
           ...
           ?>
        <center><strong id="" style="color: white;">No se llevaron a cabo las metas establecidas por el siguiente
                motivo:</strong></center>
        <select name="cumplidas" id="cumplidas" class="form-control"
            style="width: 35%; height: 35px; margin-left: auto; margin-right: auto; display: block;">
            <option value="Cumplidas">Selecciona</option>
            <option value=" Por pandemia causada por el virus SARS-COV2"> Por pandemia causada por el virus SARS-COV2
            </option>
        ...
        <center><strong id="" style="color: white;">COMENTARIO DEL JEFE INMEDIATO PARA LA EVALUACIÓN FINAL:</strong><br>
        </center>
        ...
        <textarea name="comentarioOperativo" id="operativos"
    ...
    <?php
require 'conexion.php';
$sql_f = $conexion2->query("SELECT SUM( IF(resultadobtenido != '', 1,0) + IF(resultadobtenido2 != '', 1,0) + IF(resultadobtenido3 != '', 1,0) + IF(resultadobtenido4 != '', 1,0) + IF(resultadobtenido5 != '', 1,0)) total FROM descripcionesmetas2022 where id_empleado = '$id'");
$resultado = mysqli_fetch_assoc($sql_f);

$valida1 = $resultado['total'];
if($valida2 == $valida1){
?>
    <button
        style="margin-left: auto; margin-right: auto; display: block; margin-top: -5%;cursor: pointer; border-radius: 5px;"
        class="btn btn-danger">FINALIZAR Y SOLICITAR VoBo</button>
    <?php
}elseif($validarid == 3){
?>
    <button
        style="margin-left: auto; margin-right: auto; display: block; margin-top: -5%; cursor: pointer; border-radius: 3px;"
        class="btn btn-danger">FINALIZAR Y SOLICITAR VoBo</button>
...
?>
    ...
    $('button').click(function() {
        ...
        let ident = btoa($("#identificador").val());
        ...
        if (mensaje == true) {
            window.location.href = 'emailTest?mail=' + fired_button + '&nombre=' + nombre + '&appaterno=' +
                appaterno + '&apmaterno=' + apmaterno + '&comoper=' + comoper + '&ident=' + ident +
                '&cumplidas2=' + cumplidas2;
        } else {
            swal({
                title: '¡CANCELADO!',
                text: '',
