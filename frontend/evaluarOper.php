...
include("cabecera.php");
    ...
    <input type="submit" style="width: 150px; height: 40px; margin-left: 30px; cursor: pointer; float:left; margin-top: 15px;" class="btn-warning" value="Rgresar" id="back" onclick="window.history.back()"></input>
...
<center><h1 style="font-style: italic; font-size: 30px;">Competencias</h1></center><br>
<div class="form-group">
                 <div class="titulo" >
                    <p>Transversales</p>
                    <H5>Nota: una vez iniciado un proceso TRANSVERSAL deberas concluirlo, de lo contrario el proceso quedara finalizado.</H5>
                  <?php 
...
$test = $resultadoFin['total'];
                  if($test < $tope ){
                    ...
                    data-target="#myModal_comunicaciones" data-backdrop="static" data-keyboard="false" value="<?php echo $detalle1; ?>" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 24px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                        <div class="separador" style="margin-top: 10px;"></div>
                        <?php 
                  }else{
                      ?>
                    <input type="submit" value="Proceso Finalizado" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: red; font-size: 24px; float: left; margin-left: 40%; font-style: italic;"></input><br>
                        <div class="separador" style="margin-top: 10px;"></div>
                  <?php
                  }
                  ?>
...
$test = $resultadoFin['total2'];
                  ...
                  ?>
                    ...
                    data-target="#myModal_liderazgo" data-backdrop="static" data-keyboard="false" value="<?php echo $detalle2; ?>" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 24px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                        <div class="separador" style="margin-top: 10px;"></div>
                        <?php 
                  }else{
                      ?>
...
$test = $resultadoFin['total3'];
                    ...
                    data-target="#myModal_orientacion" data-backdrop="static" data-keyboard="false" value="<?php echo $detalle3; ?>" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 24px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                        <div class="separador" style="margin-top: 10px;"></div>
                        <?php 
                  }else{
                      ?>
...
$test = $resultadoFin['total4'];
                    ...
                    data-target="#myModal_trabajo_equipo" data-backdrop="static" data-keyboard="false" value="<?php echo $detalle4; ?>" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 24px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                        <div class="separador" style="margin-top: 10px;"></div>
                        <?php 
                  }else{
                      ?>
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total5 from competencias where identificador = '$val' and transerval = '$detalle5'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total5'];
                    ...
                    data-target="#myModal_negociacion" data-backdrop="static" data-keyboard="false" value="<?php echo $detalle5; ?>" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 24px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                    ...
                    <?php 
                      ...
                      ?>
                        <input type="submit" value="Proceso Finalizado" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: red; font-size: 24px; float: left; margin-left: 40%; font-style: italic;"></input><br>                    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <center><a href="resultadosOpe.php?eval=<?php echo $val; ?>&val1=<?php echo base64_encode($detalle1); ?>&val2=<?php echo base64_encode($detalle2); ?>&val3=<?php echo base64_encode($detalle3); ?>&val4=<?php echo base64_encode($detalle4); ?>&val5=<?php echo base64_encode($detalle5); ?>" class="btn btn-danger">Ver puntaje obtenido</a></center>    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <?php
                  }
                  ?>  
...
var ID_usuario =  $("#comunicacion").val();
...
var ID_usuario =  $("#orientacion_a_resultados").val();
...
var ID_usuario =  $("#trabajo_en_equipo").val();
...
var ID_usuario =  $("#negociacion").val();
...
{ 
    var val = $('input[name=intereses]:checked').val()
    var valo =  $("#inter").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#comunic").val();
  
    var ob = {val:val, valo:valo, valo2:valo2, comunic:comunic};
...
{ 
    var val = $('input[name=intereses2]:checked').val()
    var valo =  $("#inter2").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#comunic").val();
...
{ 
    var val = $('input[name=intereses3]:checked').val()
    var valo =  $("#inter3").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#comunic").val();
...
{ 
    var val = $('input[name=intereses4]:checked').val()
    var valo =  $("#inter4").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#comunic").val();
...
{ 
    var val = $('input[name=intereses5]:checked').val()
    var valo =  $("#inter5").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#comunic").val();
...
{ 
    var val = $('input[name=intereses6]:checked').val()
    var valo =  $("#inter6").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#lidera").val();
...
{ 
    var val = $('input[name=intereses7]:checked').val()
    var valo =  $("#inter7").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#lidera").val();
...
{ 
    var val = $('input[name=intereses8]:checked').val()
    var valo =  $("#inter8").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#lidera").val();
...
{ 
    var val = $('input[name=intereses9]:checked').val()
    var valo =  $("#inter9").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#lidera").val();
...
{ 
    var val = $('input[name=intereses10]:checked').val()
    var valo =  $("#inter10").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#lidera").val();
...
{ 
    var val = $('input[name=intereses11]:checked').val()
    var valo =  $("#inter11").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#orient").val();
...
{ 
    var val = $('input[name=intereses12]:checked').val()
    var valo =  $("#inter12").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#orient").val();
...
{ 
    var val = $('input[name=intereses13]:checked').val()
    var valo =  $("#inter13").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#orient").val();
...
{ 
    var val = $('input[name=intereses14]:checked').val()
    var valo =  $("#inter14").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#orient").val();
...
{ 
    var val = $('input[name=intereses15]:checked').val()
    var valo =  $("#inter15").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#orient").val();
...
{ 
    var val = $('input[name=intereses16]:checked').val()
    var valo =  $("#inter16").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#trabajo").val();
...
{ 
    var val = $('input[name=intereses17]:checked').val()
    var valo =  $("#inter17").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#trabajo").val();
...
{ 
    var val = $('input[name=intereses18]:checked').val()
    var valo =  $("#inter18").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#trabajo").val();
...
{ 
    var val = $('input[name=intereses19]:checked').val()
    var valo =  $("#inter19").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#trabajo").val();
...
{ 
    var val = $('input[name=intereses20]:checked').val()
    var valo =  $("#inter20").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#trabajo").val();
...
<table id="table" class="table">
  ...
  <a href="resultadosOpe.php?eval=<?php echo $val; ?>&val1=<?php echo $detalle1; ?>&val2=<?php echo $detalle2; ?>&val3=<?php echo $detalle3; ?>&val4=<?php echo $detalle4; ?>&val5=<?php echo $detalle5; ?>" class="btn btn-danger">Finalizar</a>                        
<div class="modal-body" >
...
{ 
    var val = $('input[name=intereses21]:checked').val()
    var valo =  $("#inter21").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#negocio").val();
...
{ 
    var val = $('input[name=intereses22]:checked').val()
    var valo =  $("#inter22").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#negocio").val();
...
{ 
    var val = $('input[name=intereses23]:checked').val()
    var valo =  $("#inter23").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#negocio").val();
...
{ 
    var val = $('input[name=intereses24]:checked').val()
    var valo =  $("#inter24").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#negocio").val();
...
{ 
    var val = $('input[name=intereses25]:checked').val()
    var valo =  $("#inter25").val();
    var valo2 =  $("#rfc").val();
    var comunic = $("#negocio").val();
