...
<div class="form-group">
                 <div class="titulo" >
                  ...
                  <?php 
$sql = $conexion2->query("SELECT sum(ponderacion) as total from competenciasjefe2022 where identificador = '$val' and transerval = '$detalle1'");
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total2 from competenciasjefe2022 where identificador = '$val' and transerval = '$detalle2'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total3 from competenciasjefe2022 where identificador = '$val' and transerval = '$detalle3'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total4 from competenciasjefe2022 where identificador = '$val' and transerval = '$detalle4'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total5 from competenciasjefe2022 where identificador = '$val'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total5'];
                 ...
                 <input type="submit" value="Completado" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: red; font-size: 24px; float: left; margin-left: 40%; font-style: italic;"></input><br>                    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <center><a href="resultadosjefe?eval=<?php echo base64_encode($val); ?>&val1=<?php echo base64_encode($detalle1); ?>&val2=<?php echo base64_encode($detalle2); ?>&val3=<?php echo base64_encode($detalle3); ?>&val4=<?php echo base64_encode($detalle4); ?>&val5=<?php echo base64_encode($detalle5); ?>" class="btn btn-danger">Ver puntaje obtenido</a></center>    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <?php
                  }
                  ?>
