...
if (isset($_SESSION['jefe'])){
  $usernameSesion = $_SESSION['jefe'];
  
  $query ="SELECT * from jefes where rfc = '$valor' limit 1";
...
include("cabeceraJefe.php");
    ...
    $sql = $conexion2->query("SELECT * from jefes where rfc = '$val'");
...
<div class="form-group">
                            ...
                            <div class="input-group" style="width: 100%; margin-top: -15px;">
                                    ...
                                    <input name="nominaEvaluado" type="text" class="form-control" readonly="readonly"
                                        onkeyup="mayus(this);" onload="validar();" id="inputForm2" value="">
                                </div>
                            ...
                            <div class="input-group" style="width: 100%; margin-top: -15px;">
                                    ...
                                    <input name="nominaEvaluado" type="text" class="form-control" readonly="readonly"
                                        onkeyup="mayus(this);" onload="valida();" id="inputForm3" value="">
                                </div>
                            ...
                            <div class="input-group" style="width: 100%; margin-top: -15px;">
                                    ...
                                    <input name="nominaEvaluado" type="text" class="form-control" readonly="readonly"
                                        onkeyup="mayus(this);" onload="validar();" id="inputForm4" value="">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group" style="width: 40%; margin-left: 25px; ">
                                    ...
                                    <input name="nombreEvaluado" type="text" class="form-control" readonly="readonly"
                                        onkeyup="mayus(this);" value="<?php echo $result['nombrecompleto'];?>">
                                </div>
...
<div class="form-group">
                 <div class="titulo" >
                    <p>Transversales</p>
                    <h6 style="float: left; margin-left: 15px; text-align:center; color: red; font-style: italic; margin-top: -17px;">Nota: una vez iniciado un proceso de evaluación deberas concluirlo, de lo contrario tu información no quedara guardada.</h6><br>
                  <?php 
...
$test = $resultadoFin['total5'];
                 ...
                 <input type="submit" value="Completado" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: red; font-size: 24px; float: left; margin-left: 40%; font-style: italic;"></input><br>                    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <center><a href="resultados.php?eval=<?php echo base64_encode($val); ?>&val1=<?php echo base64_encode($detalle1); ?>&val2=<?php echo base64_encode($detalle2); ?>&val3=<?php echo base64_encode($detalle3); ?>&val4=<?php echo base64_encode($detalle4); ?>&val5=<?php echo base64_encode($detalle5); ?>" class="btn btn-danger">Ver puntaje obtenido</a></center>    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <?php
                  }
                  ?>
