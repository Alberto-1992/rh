...
$tiposervidor = base64_decode($_GET['tiposervidor']);
...
include("cabeceraJefe.php");
    ...
    $sql = $conexion2->query("SELECT * from personaloperativo2022 where rfc = '$val'");
...
<div class="form-group">
                 <div class="titulo" >
                    <p>Transversales</p>
                    <H5>Nota: una vez iniciado un proceso de evaluación es recomendable finalizarlo, esto con el objetivo de guardar satisfactoriamente la evaluacion, GRACIAS!.</H5>
                  <?php 
$sql = $conexion2->query("SELECT sum(ponderacion) as total from competenciasjefe where identificador = '$val' and transerval = '$detalle1'");
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total2 from competenciasjefe where identificador = '$val' and transerval = '$detalle2'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total3 from competenciasjefe where identificador = '$val' and transerval = '$detalle3'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total4 from competenciasjefe where identificador = '$val' and transerval = '$detalle4'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total5 from competenciasjefe where identificador = '$val'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total5'];
                 ...
                 <input type="submit" value="Completado" style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: red; font-size: 24px; float: left; margin-left: 40%; font-style: italic;"></input><br>                    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <center><a href="resultadosjefe.php?eval=<?php echo base64_encode($val); ?>&val1=<?php echo base64_encode($detalle1); ?>&val2=<?php echo base64_encode($detalle2); ?>&val3=<?php echo base64_encode($detalle3); ?>&val4=<?php echo base64_encode($detalle4); ?>&val5=<?php echo base64_encode($detalle5); ?>" class="btn btn-danger">Ver puntaje obtenido</a></center>    
                        <div class="separador" style="margin-top: 10px;"></div><br>
                        <?php
                  }
                  ?>
...
let ob = {ID_usuario:ID_usuario};
 ...
 $.ajax({
            type: "POST",
            url:"consulta_descripciones_jefe.php",
            data: ob,
...
<table id="table" class="table">
  ...
  <tbody>
    <tr>
      ...
      <td><input name="intereses" type="radio" onclick="btn_localiz1();" value="20" /></td>
      <td><input name="intereses" type="radio" onclick="btn_localiz1();" value="16"/></td>
      <td><input name="intereses" type="radio" onclick="btn_localiz1();" value="13" /></td>
      <td><input name="intereses" type="radio" onclick="btn_localiz1();" value="6"  /></td>
    </tr>
    <tr>
        <input type="hidden" id="comunic" value="<?php echo $resul['nombrecompetencia']; ?>">
        <input type="hidden" id="inter2" value="<?php echo $resul27['descripcionconpetencia']; ?>">
    <td><?php echo $resul27['descripcionconpetencia']; ?> </td>
      <td><input name="intereses2" type="radio" onclick="btn_localiz2();" value="20"/></td>
      <td><input name="intereses2" type="radio" onclick="btn_localiz2();" value="16" /></td>
      <td><input name="intereses2" type="radio" onclick="btn_localiz2();" value="13"  /></td>
      <td><input name="intereses2" type="radio" onclick="btn_localiz2();" value="6"  /></td>
    </tr>
    <tr>
    <input type="hidden" id="comunic" value="<?php echo $resul['nombrecompetencia']; ?>">
    <input type="hidden" id="inter3" value="<?php echo $resul28['descripcionconpetencia']; ?>">
    <td><?php echo $resul28['descripcionconpetencia']; ?> </td>
      <td><input name="intereses3" type="radio" onclick="btn_localiz3();" value="20" /></td>
      <td><input name="intereses3" type="radio" onclick="btn_localiz3();" value="16" /></td>
      <td><input name="intereses3" type="radio" onclick="btn_localiz3();" value="13" /></td>
      <td><input name="intereses3" type="radio" onclick="btn_localiz3();" value="6" /></td>
    </tr>
    <tr>
    <input type="hidden" id="comunic" value="<?php echo $resul['nombrecompetencia']; ?>">
    <input type="hidden" id="inter4" value="<?php echo $resul29['descripcionconpetencia']; ?>">
    <td><?php echo $resul29['descripcionconpetencia']; ?></td>
      <td><input name="intereses4" type="radio" onclick="btn_localiz4();" value="20" /></td>
      <td><input name="intereses4" type="radio" onclick="btn_localiz4();" value="16"  /></td>
      <td><input name="intereses4" type="radio" onclick="btn_localiz4();" value="13" /></td>
      <td><input name="intereses4" type="radio" onclick="btn_localiz4();" value="6"/></td>
    </tr>
    <tr>
    <input type="hidden" id="comunic" value="<?php echo $resul['nombrecompetencia']; ?>">
    <input type="hidden" id="inter5" value="<?php echo $resul30['descripcionconpetencia']; ?>">
    <td><?php echo $resul30['descripcionconpetencia']; ?> </td>
      <td><input name="intereses5" type="radio" onclick="btn_localiz5();" value="20"/></td>
      <td><input name="intereses5" type="radio" onclick="btn_localiz5();" value="16" /></td>
      <td><input name="intereses5" type="radio" onclick="btn_localiz5();" value="13"/></td>
      <td><input name="intereses5" type="radio" onclick="btn_localiz5();" value="6"/></td>
    </tr>
  </tbody>
</table>
