...
require 'conexion.php';
  ...
  $query ="SELECT tiposervidor from personaloperativo2022 where rfc = '$valor' limit 1";
...
include("cabecera.php");
    ...
    <input type="submit"
        ...
        class="btn-warning" value="Regresar" id="back" onclick="window.history.back();">
    ...
    <div class="datosEvaluado">
        ...
        <div class="form-group col-md-4"
            style="width: 800px; height: 320px; background: withe; float:right; margin-right: 100px; margin-top: -65px;">
            ...
            <div class="form-group">
                <div class="input-group" style="width: 100%; margin-top: -15px;">
                    ...
                    <input name="nominaEvaluado" type="hidden" class="form-control" readonly="readonly"
                        onkeyup="mayus(this);" onclick="validar();" id="inputForm"
                        value="<?php echo $result['funciones6']; ?>">
                </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <input name="nombreEvaluado" type="text" class="form-control" readonly="readonly" onkeyup="mayus(this);"
                    value="<?php echo $result['nombre']." ".$result['apellidopaterno']." ".$result['apellidomaterno']; ?>">
            </div>
            ...
            <div class="input-group">
                ...
                <input name="puestoEvaluado" type="text" class="form-control" readonly="readonly" onkeyup="mayus(this);"
    ...
    <div class="datosEvaluador">
        <center>
            <h1 style="font-style: italic; font-size: 27px;">Competencias</h1>
        </center><br>
        <div class="form-group">
            <div class="titulo">
                <p>Transversales</p>
                ...
                <?php 
$sql = $conexion2->query("SELECT sum(ponderacion) as total from competencias2022 where identificador = '$val' and transerval = '$detalle1'");
...
$test = $resultadoFin['total'];
                ...
                <input type="submit" id="comunicacion" onclick="localizar1();" data-toggle="modal"
                    data-target="#myModal_comunicaciones" data-backdrop="static" data-keyboard="false"
                    value="<?php echo $detalle1; ?>"
                    style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 20px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                <div class="separador" style="margin-top: 10px;"></div>
                <?php 
                  }else{
                      ?>
                <input type="submit" value="Completado"
                    style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: red; font-size: 24px; float: left; margin-left: 40%; font-style: italic;"></input><br>
                <div class="separador" style="margin-top: 10px;"></div>
                <?php
                  }
                  ?>
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total2 from competencias2022 where identificador = '$val' and transerval = '$detalle2'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total2'];
                ...
                <input type="submit" id="liderazgo" onclick="localizar2();" data-toggle="modal"
                    data-target="#myModal_liderazgo" data-backdrop="static" data-keyboard="false"
                    value="<?php echo $detalle2; ?>"
                    style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 20px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                <div class="separador" style="margin-top: 10px;"></div>
                <?php 
                  }else{
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total3 from competencias2022 where identificador = '$val' and transerval = '$detalle3'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total3'];
                ...
                <input type="submit" id="orientacion_a_resultados" onclick="localizar3();" data-toggle="modal"
                    data-target="#myModal_orientacion" data-backdrop="static" data-keyboard="false"
                    value="<?php echo $detalle3; ?>"
                    style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 20px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                <div class="separador" style="margin-top: 10px;"></div>
                <?php 
                  }else{
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total4 from competencias2022 where identificador = '$val' and transerval = '$detalle4'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total4'];
                ...
                <input type="submit" id="trabajo_en_equipo" onclick="localizar4();" data-toggle="modal"
                    data-target="#myModal_trabajo_equipo" data-backdrop="static" data-keyboard="false"
                    value="<?php echo $detalle4; ?>"
                    style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 20px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                <div class="separador" style="margin-top: 10px;"></div>
                <?php 
                  }else{
...
$sql = $conexion2->query("SELECT sum(ponderacion) as total5 from competencias2022 where identificador = '$val'");
$resultadoFin = mysqli_fetch_assoc($sql);
...
$test = $resultadoFin['total5'];
                ...
                <input type="submit" id="negociacion" onclick="localizar5();" data-toggle="modal"
                    data-target="#myModal_negociacion" data-backdrop="static" data-keyboard="false"
                    value="<?php echo $detalle5; ?>"
                    style="background: none;  border: none;  cursor: pointer;  outline: inherit; color: blue; font-size: 20px; float: left; margin-left: 5%; font-style: italic;"></input><br>
                ...
                <div class="separador" style="margin-top: 10px;"></div><br>
                <center><a
                        href="resultados?eval=<?php echo base64_encode($val); ?>&val1=<?php echo base64_encode($detalle1); ?>&val2=<?php echo base64_encode($detalle2); ?>&val3=<?php echo base64_encode($detalle3); ?>&val4=<?php echo base64_encode($detalle4); ?>&val5=<?php echo base64_encode($detalle5); ?>"
                        class="btn btn-danger">Ver puntaje obtenido</a></center>
                <div class="separador" style="margin-top: 10px;"></div><br>
                <?php
                  }
                  ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table id="table" class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input id="intereses" name="intereses" type="radio" onclick="btn_localiz1();"
                                    value="20" /></td>
                            <td><input id="intereses" name="intereses" type="radio" onclick="btn_localiz1();"
                                    value="16" /></td>
                            <td><input id="intereses" name="intereses" type="radio" onclick="btn_localiz1();"
                        ...
                        <tr>
                            ...
                            <td><input id="intereses2" name="intereses2" type="radio" onclick="btn_localiz2();"
                                    value="20" /></td>
                            <td><input id="intereses2" name="intereses2" type="radio" onclick="btn_localiz2();"
                                    value="16" /></td>
                            <td><input id="intereses2" name="intereses2" type="radio" onclick="btn_localiz2();"
                        ...
                        <tr>
                            ...
                            <td><input id="intereses3" name="intereses3" type="radio" onclick="btn_localiz3();"
                                    value="20" /></td>
                            <td><input id="intereses3" name="intereses3" type="radio" onclick="btn_localiz3();"
                                    value="16" /></td>
                            <td><input id="intereses3" name="intereses3" type="radio" onclick="btn_localiz3();"
                        ...
                        <tr>
                            ...
                            <td><input id="intereses4" name="intereses4" type="radio" onclick="btn_localiz4();"
                                    value="20" /></td>
                            <td><input id="intereses4" name="intereses4" type="radio" onclick="btn_localiz4();"
                                    value="16" /></td>
                            <td><input id="intereses4" name="intereses4" type="radio" onclick="btn_localiz4();"
                        ...
                        <tr>
                            ...
                            <td><input id="intereses5" name="intereses5" type="radio" onclick="btn_localiz5();"
                                    value="20" /></td>
                            <td><input id="intereses5" name="intereses5" type="radio" onclick="btn_localiz5();"
                                    value="16" /></td>
                            <td><input id="intereses5" name="intereses5" type="radio" onclick="btn_localiz5();"
                ...
                <input type="submit" class="btn btn-warning" data-dismiss="modal" value="Enviar"
