...
$sql_1 = $conexion2->query("UPDATE descripcionesmetas2022 set comentario = '$comentario' where id_empleado = $id");
$sql_2 = $conexion2->query("UPDATE personaloperativo2022 set vistobueno = 2, actualiza = 2, finalizofecha = '$hoy' where id_empleado = $id");
