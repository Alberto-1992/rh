...
error_reporting(0);
			...
			if (isset($_SESSION['usuarioJefe'])){
				...
				$query ="SELECT nombre from jefes2022 where correo = '$usernameSesion' limit 1";
...
<div class="line-cabecera" style="width: 100%; height: 10px;; position:fixed; background: #185F31;">
...
<div class="menu" style="height: auto; background: #185F31;">
<ul class="nav justify-content-end">
<li class="nav-item" >
<input type="text"
            style="width:280px; text-align: center; height:30px; margin-top:5px; font-size:18px; font-style: normal; color:yellow; border:none; background: #185F31; border-radius:5px; margin-right: 40px;"
            disabled value="HOLA&nbsp;&nbsp;<?php echo $rw['nombre']; ?>">
            </li>
<ul class="nav justify-content-end">
  <li class="nav-item" styles="float:left">
    <a class="nav-link active" style=" float:left;">HRAEI</a>
  </li>
<ul class="nav justify-content-end">
  <li class="nav-item">
                    ...
                    <form action="ingresarPasswordNuevo.php" method="POST">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <p style="color:black; text-align: left;">Para poder realizar el cambio de contraseña solo debe de seguir los siguientes pasos:</p>
                                <p style="color:black; text-align: left;">1.- Capture su contraseña anterior.</p>
                                <p style="color:black; text-align: left;">2.- Capture su nueva contraseña, se debe de incluir un caracter especial($,#,%,&,!,(,/,*,=,?,¿)) .</p>
                                <p style="color:black; text-align: left;">3.- Confirme su nueva contraseña.</p>
                                <p style="color:black; text-align: left;">4.- Su contraseña debe de incluir minimo 8 carateres alfanuméricos.</p>
                                <p style="color:black; text-align: left;">5.- Al final solo de clic sobre el botón de cambiar.</p><br>
                                ...
                                <div class="input-group" style="margin-top: 15px;">
                                    ...
                                    <input name="usuario" type="text" class="form-control" required="required"
                                        onkeyup="mayus(this);" readonly="readonly" value="<?php echo $rw['nombreUsuario']; ?>">
                                </div>
