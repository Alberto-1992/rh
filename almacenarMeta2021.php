...
if(isset($_POST['guardar'])){
   ...
   $sql_1 = $conexion2->query("SELECT id_empleado from descripcionesmetas2021 where id_empleado = $id");
   $result = mysqli_fetch_assoc($sql_1);
   
   $id_empleado = $result['id_empleado'];
    
    if($id_empleado != $id ){
    $sql = $conexion2->query("INSERT into descripcionesmetas2021 (id_empleado, redacionMeta1, indicadorMeta1, ponderacionMeta1, fechaCumpMeta1, NivelCumpNoAproMeta1, NivelCumpAproMeta1, NivelCumpSatisfMeta1, NivelCumpSobreMeta1, unidadmedida1 ) values($id,'$meta1','$indicador1', $ponderacionuno, '$fecha1', '$nivel1', '$nivel2', '$nivel3', '$nivel4','$unidadMedida1')");
    }else{
    $sql = $conexion2->query("UPDATE descripcionesmetas2021 set ponderacionMeta2 =$ponderaciondos, redacionMeta2 = '$meta2', indicadorMeta2= '$indicador2', fechaCumpMeta2 = '$fecha2',  NivelCumpNoAproMeta2 = '$nivel5',  NivelCumpAproMeta2 = '$nivel6',  NivelCumpSatisfMeta2 = '$nivel7',  NivelCumpSobreMeta2 = '$nivel8', unidadmedida2 = '$unidadMedida2' where id_empleado = $id");
    }
    if($id_empleado == $id ){
    $sql = $conexion2->query("UPDATE descripcionesmetas2021 set ponderacionMeta3 =$ponderaciontres, redacionMeta3 = '$meta3', indicadorMeta3= '$indicador3', fechaCumpMeta3 = '$fecha3',  NivelCumpNoAproMeta3 = '$nivel9',  NivelCumpAproMeta3 = '$nivel10',  NivelCumpSatisfMeta3 = '$nivel11',  NivelCumpSobreMeta3 = '$nivel12', unidadmedida3 = '$unidadMedida3' where id_empleado = $id");
    }else{
        
    }
    if($id_empleado == $id ){
    $sql = $conexion2->query("UPDATE descripcionesmetas2021 set ponderacionMeta4 =$ponderacioncuatro, redacionMeta4 = '$meta4', indicadorMeta4= '$indicador4', fechaCumpMeta4 = '$fecha4',  NivelCumpNoAproMeta4 = '$nivel13',  NivelCumpAproMeta4 = '$nivel14',  NivelCumpSatisfMeta4 = '$nivel15',  NivelCumpSobreMeta4 = '$nivel16', unidadmedida4 = '$unidadMedida4' where id_empleado = $id");
    }else{
        
    }
    if($id_empleado == $id ){
    $sql = $conexion2->query("UPDATE descripcionesmetas2021 set ponderacionMeta5 =$ponderacioncinco, redacionMeta5 = '$meta5', indicadorMeta5 = '$indicador5', fechaCumpMeta5 = '$fecha5',  NivelCumpNoAproMeta5 = '$nivel17',  NivelCumpAproMeta5 = '$nivel18',  NivelCumpSatisfMeta5 = '$nivel19',  NivelCumpSobreMeta5 = '$nivel20', unidadmedida5 = '$unidadMedida5' where id_empleado = $id");
    }else{
