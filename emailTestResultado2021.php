...
$message = "Te informamos que se ha capturado el resultado obtenido de las metas que comprendierón la consecución de resultados del periodo 1 de enero al 31 de diciembre de 2020 y quedan en espera de su Visto Bueno.
...
$sql = $conexion2->query("UPDATE descripcionesmetas2021 set comentario = '$comoper', cumplio = '$cumplidas' where id_empleado = $ident");
$sql = $conexion2->query("UPDATE personaloperativo set vistobuenoResultado2021 = 2 where id_empleado = $ident");
